...
console.log(`Total elements in the array is: ${arrayNum.length -3}`);
...
let arrayN1 = [11, 22, 33, 44, 55, 66, 77];
console.log(arrayNN);
...
console.log("----------------insert  Element middle -------------------------");
var arrayN=[11,22,33,44,55,66,77,88];
